 ...
 * @property {function} [saveRollbackData] // function(rollbackBlock): void | Promise<void> (fire-and-forget)
 * @property {object}   [initialRollbackData] // optional preloaded {watch, offerToTrade, cursor}
 */
...
function TradeOfferManager(options) {
	...
	this.saveRollbackData = typeof options.saveRollbackData === 'function' ? options.saveRollbackData : null;
