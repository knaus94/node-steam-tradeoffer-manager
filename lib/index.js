 ...
 * @property {number}  [rollbackWindowMs=604800000] // 7 days
 * @property {number}  [rollbackMaxPagesPerCycle=3]
...
function TradeOfferManager(options) {
	...
	this.rollbackMaxWatchChecksPerCycle = options.rollbackMaxWatchChecksPerCycle || 200;
