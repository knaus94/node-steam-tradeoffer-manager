...
function TradeOfferManager(options) {
	...
	this.rollbackWindowMs = options.rollbackWindowMs || 8 * 24 * 60 * 60 * 1000;
	this.rollbackMaxPagesPerCycle = options.rollbackMaxPagesPerCycle ?? 1;
	this.rollbackHistoryPageSize = options.rollbackHistoryPageSize ?? 200;

	this.rollbackPerCycleStatusChecks =
		options.rollbackPerCycleStatusChecks ?? 50;
	this.rollbackFirstCheckDelayMs =
		options.rollbackFirstCheckDelayMs ?? 60 * 1000;
	this.rollbackBackoffScheduleMs = options.rollbackBackoffScheduleMs ?? [
		60 * 1000,
		5 * 60 * 1000,
		15 * 60 * 1000,
		60 * 60 * 1000,
