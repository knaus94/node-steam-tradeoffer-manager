 ...
 * @property {number} [rollbackPollInterval=45000]
...
function TradeOfferManager(options) {
	...
	this.rollbackPollInterval = options.rollbackPollInterval || 45000;
	...
	this.rollbackAnchorGapSec = options.rollbackAnchorGapSec || 900;
	this.rollbackMaxWatchChecksPerCycle =
		options.rollbackMaxWatchChecksPerCycle || 200;
	this.rollbackMaxWatchCount = options.rollbackMaxWatchCount;
	this.rollbackMaxRolledCount = options.rollbackMaxRolledCount;
